...
//
//     final workOrderBoqModel = workOrderBoqModelFromJson(jsonString);

import 'dart:convert';

WorkOrderBoqModel workOrderBoqModelFromJson(String str) => WorkOrderBoqModel.fromJson(json.decode(str));

String workOrderBoqModelToJson(WorkOrderBoqModel data) => json.encode(data.toJson());

class WorkOrderBoqModel {
  bool? success;
  List<Result>? result;
  String? message;
  ...
  factory WorkOrderBoqModel.fromJson(Map<String, dynamic> json) => WorkOrderBoqModel(
...
class Result {
  ...
  List<dynamic>? subcontractWorkOrderAddLessSetuplink;
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
    ...
    subcontractWorkOrderAddLessSetuplink: List<dynamic>.from(json["subcontractWorkOrderAddLessSetuplink"].map((x) => x)),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "subcontractWorkOrderAddLessSetuplink": List<dynamic>.from(subcontractWorkOrderAddLessSetuplink!.map((x) => x)),
  };
}
