                ...
                children: <Widget>[
                  Padding(
                    padding: EdgeInsets.only(
                        top: 16.r, left: 8.r, right: 8.r, bottom: 8.r),
                    child: Row(
                      children: [
                        Expanded(
                          flex: 1,
                        ...
                        Expanded(
                          ...
                          child: Padding(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                await controller.todayPunchInController(
                                    "Today Report", controller.todayDate.text);
                              },
                  ...
                  loginController.user.value.userType == "A"
                      ? Padding(
                          padding:
                              EdgeInsets.only(left: 10, right: 10, bottom: 8.r),
                          child: Container(
                            ...
                            child: Card(
                              ...
                              child: TextFormField(
                                ...
                                controller:
                                    controller.todayRpteditingController,
                                decoration: InputDecoration(
                  ...
                  Padding(
                    padding:
                        EdgeInsets.only(left: 8.r, right: 8.r, bottom: 8.r),
                    child: Card(
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(10.0)),
                      color: Colors.white,
                            ...
                            child: Card(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ...(employee.punchDetails != null &&
                                          employee.punchDetails!.isNotEmpty
                                      ? employee.punchDetails!.map((detail) {
                                          bool isLastItem = detail ==
                                              employee.punchDetails!.last;
                                          return Padding(
                                            padding: const EdgeInsets.only(
                                                bottom: 10,
                                                left: 10,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        detail.punchInTime != null &&
                                                                            ...
                                                                            ? DateFormat("hh:mm a").format(
                                                                                DateFormat("hh:mm:ss a").parse(detail.punchInTime!),
                                                                              )
                                                                            : "-",
                                                                        style:
                                                                            const TextStyle(
                                                              ...
                                                              child: Row(
                                                                children: [
                                                                  ...
                                                                  SizedBox(
                                                                    width: 120,
                                                                    child: Text(
                                                                      detail.punchOutTime != null &&
                                                                              detail.punchOutTime != "" &&
                                                                              detail.punchOutTime != "null"
                                                                          ? DateFormat("hh:mm a").format(
                                                                              DateFormat("hh:mm:ss a").parse(detail.punchOutTime!),
                                                                            )
                                                                          : "-",
                                                                      style:
                                                                          const TextStyle(
