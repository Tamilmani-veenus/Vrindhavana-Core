                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                onTap: () async {
                                  ...
                                  if (punchInController.fromDate.text.isNotEmpty) {
                                    fromDateParsed =
                                        DateFormat('yyyy-MM-dd').parse(punchInController.fromDate.text);
                                  }
                                  var todate = await showDatePicker(
                                    context: context,
                                    initialDate: DateTime.now(),
                                    firstDate: fromDateParsed ?? DateTime(2010),
                                    lastDate: now,
                  ...
                  Expanded(
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        var listItem = punchInController.punchFilterRxList[index];
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Align(
                                    ...
                                    child: Text(
                                      (listItem!.staffName != "" && listItem!.staffName != "null")
                                          ? listItem!.staffName!
                                          : "-",
                                            ...
                                            children:[
                                                  ...
                                                  Row(
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: Icon(Icons.access_time, size: 16, color: Theme.of(context).primaryColor,),
                                                      ),
                                                      SizedBox(width: 5,),
                                                        ...
                                                        child: Row(
                                                          children: [
                                                            ...
                                                            SizedBox(
                                                              ...
                                                              child: Text(
                                                                '${index.punchInTime != "" &&
                                                                    index.punchInTime != "null" ?
                                                                DateFormat("hh:mm a").format(DateFormat("HH:mm:ss").parse(index.punchInTime!)):"-"}',
                                                                style: const TextStyle(
                                                                  fontSize: 13,
                                                                  fontWeight: FontWeight.bold,
                                                                  color: Colors.black,
                                              ...
                                              GestureDetector(
                                                child: Container(height: height*0.2,width: width*0.2,
                                                  child:Image.network(index.inImageUrl!,fit: BoxFit.cover,),),
                                                onTap:(){
                                                  Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          SizedBox(
                                                            width: 120,
                                                            child: Text(
                                                              '${index.punchOutTime != null &&
                                                                  index.punchOutTime != "" && index.punchOutTime != "null" ?
                                                              DateFormat("hh:mm a").format(DateFormat("HH:mm:ss").parse(index.punchOutTime!)):"-"}',                                                          style: const TextStyle(
                                                              fontSize: 13,
                                                              fontWeight: FontWeight.bold,
                                                              color: Colors.black,
                                                            ),
