...
import 'package:vrindhavanacore/newhome/maindashboard/labourDashboard.dart';
...
class _Home_DashboardState extends State<Home_Dashboard> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await dashboard_controller.DashboardEntryList();
    });
  }
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: WillPopScope(
          ...
          Obx((){
            return dashboard_controller.main_List.isEmpty ?
            SizedBox() :
            ListView.builder(
                shrinkWrap: true,
                physics: BouncingScrollPhysics(),
                padding: EdgeInsets.only(
                    bottom: BaseUtitiles.getheightofPercentage(context, 7)),
                            ...
                            Flexible(
                              ...
                              child: Container(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    await projectController.getProjectListAll(context);
                                    showDialog(
                                        context: context,
                                        builder: (BuildContext context) {
        ...
        child: Obx((){
          return Scrollbar(
            ...
            child: ListView.builder(
              ...
              itemCount: projectController.getdropDownvalueAll.value.length, // Set your item count
              itemBuilder: (BuildContext context, int index) {
                return Column(
                  children: [
                    InkWell(
                      child: Container(
                        child: Padding(
                          ...
                          child: Text(
                            projectController
                                .getdropDownvalueAll.value[index].project
                                .toString(),
                            style: TextStyle(
