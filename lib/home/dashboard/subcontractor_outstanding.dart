...
class _SubcontractorState extends State<Subcontractoroutstanding> {
  ...
  void initState() {
    ...
    Future.delayed(duration, () async {
      ...
      expensesController.totalSubamt.value = 0;
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        onTap: () async {
                          ...
                          if(mounted) {
                            bottomsheetControllers.CompanyName(
                                context, companyController.getdropDownvalue.value);
                          }
                        },
                        validator: (value) {
                          if (value!.isEmpty ||
                      ...
                      onTap: ()  {
                        setState(() {
                          if(_formKey.currentState!.validate()){
                            ...
                            expensesController.getSubcontractor_ExpensesList(companyController.SupplierlistFrDate.text,companyController.SupplierlistToDate.text);
                          }
                        });
                        },
                    ),
                        ...
                        children: [
                          ...
                          Expanded(
                              ...
                              child: Align(
                                  ...
                                  child: Obx(()=>
                                     Text("₹ ${expensesController.totalSubamt.value.toStringAsFixed(2)}",
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Align(
                              alignment: Alignment.centerRight,
                              child: Text(
                                ("₹ " + expensesController.subcontractorOSExpensesList.value[index].balanceAmount.toStringAsFixed(2)),
