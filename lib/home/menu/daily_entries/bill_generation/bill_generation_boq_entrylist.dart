...
class Bill_Generation_Boq_Entrylist extends StatefulWidget {
  ...
  State<Bill_Generation_Boq_Entrylist> createState() =>
      _Bill_Generation_Boq_EntrylistState_Site();
}

class _Bill_Generation_Boq_EntrylistState_Site
    extends State<Bill_Generation_Boq_Entrylist> {
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        flex: 8,
                                        child: Text(
                                          billGenerationBoqController.bill_entryList.value[index].projectName.toString(),
                                          style: TextStyle(
                                            color: Colors.black,),
                                        )),
                                  ],
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        flex: 8,
                                        child: Text(
                                          billGenerationBoqController.bill_entryList.value[index].fromWorkDate.toString(),
                                          style: TextStyle(
                                            color: Colors.black,
                                          ),
                                        )),
                                ...
                                Row(
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                        flex: 8,
                                        child: Text(
                                          billGenerationBoqController.bill_entryList.value[index].toWorkDate.toString(),
                                          style: TextStyle(
                                            color: Colors.black,),
                                        )),
                                  ],
