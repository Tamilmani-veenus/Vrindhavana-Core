...
import 'package:vrindhavanacore/controller/comman_controller.dart';
...
class _MatTransReqListState extends State<MatTransReqList> {
  ...
  void initState() {
    ...
    materialTransferReqController.mainmatTransReqList.value.clear();
    materialTransferReqController.matTransReqList.value.clear();

    DateTime currentDate = DateTime.now();
    DateTime lastDayOfMonth = DateTime(currentDate.year, currentDate.month - 1, 0);
    materialTransferReqController.matTransReqListFrDate.text = lastDayOfMonth.toString().substring(0, 10);
    materialTransferReqController.matTransReqListToDate.text = currentDate.toString().substring(0, 10);
    materialTransferReqController.getListMatTransReq();
    materialTransferReqController.matTransReqList.value = materialTransferReqController.mainmatTransReqList.value;
    super.initState();
  }
                          ...
                          Container(
                            ...
                            child: Card(
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  readOnly: true,
                                  controller: materialTransferReqController.matTransReqListFrDate,
                                  ...
                                  onTap: () async {
                                    ...
                                    materialTransferReqController.matTransReqListFrDate.text = Frdate.toString().substring(0, 10);
                                  },
                                ),
                              ),
                            ),
                          ...
                          Container(
                            ...
                            child: Card(
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  readOnly: true,
                                  controller: materialTransferReqController.matTransReqListToDate,
                                  cursorColor: Colors.black,
                                  ...
                                  onTap: () async {
                                    ...
                                    materialTransferReqController.matTransReqListToDate.text = Todate.toString().substring(0, 10);
                                  },
                                ),
                              ),
                            ),
                          ...
                          children: [
                            Container(
                              ...
                              child: TextField(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    materialTransferReqController.matTransReqList.value = BaseUtitiles.filterSearchResults_MaterialTransferRequest(value, materialTransferReqController.mainmatTransReqList);
                                  });
                                },
                              ),
                            ),
        ...
        children: [
          Container(
            ...
            child: Obx(() => ListView.builder(
                shrinkWrap: true,
                physics: BouncingScrollPhysics(),
                padding: EdgeInsets.only(bottom: MediaQuery.of(context).size.height * 10/100,),
                itemCount: materialTransferReqController.matTransReqList.value .length,
                            ...
                            Row(
                              ...
                              children: [
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text(
                                            materialTransferReqController.matTransReqList.value[index].transferEntryDate.toString(),
                                            style: TextStyle(
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    materialTransferReqController.matTransReqList.value[index].transferNo.toString(),
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Expanded(
                                    flex: 8,
                                    child: Text(
                                      materialTransferReqController.matTransReqList.value[index].fromProjectName.toString(),
                                      style: TextStyle(
                                        color: Colors.black,
                                      ),
                                    )),
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Expanded(
                                    flex: 8,
                                    child: Text(
                                      materialTransferReqController.matTransReqList.value[index].toProjectName.toString(),
                                      style: TextStyle(
                                        color: Colors.black,
                                      ),
                                    )),
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Expanded(
                                    ...
                                    child: IconButton(
                                        onPressed: () {
                                          if(materialTransferReqController.matTransReqList.value[index].status == "Verified" || materialTransferReqController.matTransReqList.value[index].status.toString() == "Approved"){
                                            BaseUtitiles.showToast("Transfer Request ${materialTransferReqController.matTransReqList.value[index].status} Cannot be Edited");
                                          }else{
                                                      ...
                                                      children: [
                                                        ...
                                                        Visibility(
                                                          ...
                                                          child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                Navigator.pop(context);
                                                                materialTransferReqController.DeleteAlert(context, index);
                                                              }),
                                                        ),
                                                        SizedBox(height: 20),
                                                      ],
