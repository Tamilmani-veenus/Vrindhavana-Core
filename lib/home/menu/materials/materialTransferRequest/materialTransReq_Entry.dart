...
import 'package:vrindhavanacore/controller/auto_yrwise_no_controller.dart';
...
class _MaterialTransReqEntryState extends State<MaterialTransReqEntry> {
  ...
  void initState() {
    ...
    Future.delayed(duration, () async {
      ...
      if (materialTransferReqController.saveButton.value == RequestConstant.RESUBMIT || materialTransferReqController.saveButton.value == RequestConstant.VERIFY || materialTransferReqController.saveButton.value == RequestConstant.APPROVAL) {
        materialTransferReqController.mattranReqEditListValue.forEach((element) {
          materialTransferReqController.matTansReqId = element.id;
          materialTransferReqController.autoyrwiseText.text = element.transferNo.toString();
          materialTransferReqController.entryDateText.text =
              element.transferEntryDate.toString();
          fromprojectController.fromprojectname.text =
              element.fromProjectName.toString();
          fromprojectController.selectedProjectId.value = element.fromProjectId;
          fromsiteController.FromSitename.text = element.siteName.toString();
  ...
  Widget build(BuildContext context) {
    ...
    final double height = MediaQuery.of(context).size.height * 5 / 100;
    return Form(
      key: _formkey,
      child: GestureDetector(
                        ...
                        if (_formkey.currentState!.validate()) {
                          ...
                          if (materialTransferReqController
                            ...
                            for (int i = 0;
                                ...
                                i++) {
                              final controller = materialTransferReqController
                                  .Show_Itemlist_TransQtyController[i];
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        ElevatedButton(
                            ...
                            onPressed: () async {
                              if (_formkey.currentState!.validate()) {
                                _formkey.currentState!.save();
                                await materialTransferReqController.getItemList(
                                    fromprojectController
                                        .selectedProjectId.value,
                    ...
                    Obx(
                      () => Visibility(
                        visible: materialTransferReqController
        ...
        //                         await fromprojectController.getProjectList(context, 0, 0);
        //                         if (mounted) {
                    ...
                    child: TextButton(
                      onPressed: () async {
                        ...
                        materialTransferReqController.prearedbyText.text =
                            loginController.EmpName();
                        materialTransferReqController.remarksText.text = "";
                        materialTransferReqController.zeroTransferQtyCount = 0;
                        setState(() {
                          materialTransferReqController.itemlistTable_Delete();
                          materialTransferReqController
  ...
  Future SubmitAlert(BuildContext context) async {
    return await showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Alert!'),
        content: Text(
          'Are you sure to ${materialTransferReqController.saveButton.value}?',
        ),
        actions: [
          Container(
            margin: const EdgeInsets.only(left: 20, right: 20),
                      ...
                      builder: (context, setState) => TextButton(
                          onPressed: () async {
                                if (await BaseUtitiles.checkNetworkAndShowLoader(context)) {
                                  ...
                                  await materialTransferReqController.SaveEntryScreen(
                                    context,
                                    materialTransferReqController.matTansReqId,
                                  );
                                }
                          },
                          child: Text(
