...
//
// class Subcontractor_ReportPdf {
//
//   static Future<File> generate(Pdfmodel pdfmodel, List<PdfListModel> SubContAttend_List) async {
//     final pdf = Document();
//
...
//         buildTitle(pdfmodel),
//         buildHeading(pdfmodel, SubContAttend_List ),
//         Divider(),
//       ],
//       // footer: (context) => buildFooter(invoice),
//     ));
//     return Pdf_OpenfilePath.saveDocument(name: 'SubContractor_Report.pdf', pdf: pdf);
//   }
//
...
//   );
//
//   static Widget buildHeading(Pdfmodel pdfmodel, List<PdfListModel> SubContAttend_List) {
//     final headers = [
//       "SubContractor Name",
//       "Project Name",
//       "Status",
