...
//
// class MRN_Report_PDF{
//
//   static Future<File> generate(Pdfmodel pdfmodel, List<PdfListModel> MRNReport_List) async {
//     final pdf = Document();
//
...
//         buildTitle(pdfmodel),
//         buildHeading(pdfmodel, MRNReport_List ),
//         Divider(),
//       ],
//       // footer: (context) => buildFooter(invoice),
//     ));
//     return Pdf_OpenfilePath.saveDocument(name: 'MRN_Report.pdf', pdf: pdf);
//   }
//
...
//   );
//
//   static Widget buildHeading(Pdfmodel pdfmodel, List<PdfListModel> MRNReport_List) {
//     final headers = [
//       "Req No",
//       "Date",
//       "Project Name",
